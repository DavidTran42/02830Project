...
var ChatHeader = function ChatHeader2(props) {
  ...
  var onFilesSelect = function onFilesSelect2(e) {
    ...
    import_axios.default.post("https://api.chatengine.io/chats/" + props.chat.id + "/messages/", formdata, {
      headers
    }).then(function() {
  ...
  var onDelete = function onDelete2() {
    ...
    import_axios.default["delete"]("https://api.chatengine.io/chats/" + props.chat.id + "/", {
      headers
    }).then(function(r) {
...
var ChatForm = function ChatForm2(props) {
  ...
  var getAllUsers = function getAllUsers2(onSuccess, onError) {
    import_axios.default.get("https://api.chatengine.io/users/search/", {
      headers: {
        "Project-ID": props.projectId,
        "User-Name": props.username,
        "User-Secret": props.secret
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              import_axios.default.put("https://api.chatengine.io/chats/", data, {
                headers
              }).then(function(r) {
